...
const BEAM_LAYERS = [
  { width: 13.0898, blur: 26.1796, stops: ["#FF66CC", "#FF1493"] },
  { width: 10.4719, blur: 15.7078, stops: ["#FF66CC", "#FF1493"] },
  { width: 7.85389, blur: 10.4719, stops: ["#FF66CC", "#FF1493"] },
  { width: 1.96347, blur: 7.85389, stops: ["#FF66CC", "#FF1493"] },
  { width: 1.96347, blur: 3.92695, stops: ["#FF66CC", "#FF1493"] },
  { width: 1.96347, blur: 2.61796, stops: ["#FF66CC", "#FF1493"] },
  { width: 1.30898, blur: 1.30898, stops: ["#FF66CC", "#FF1493"] },
  { width: 0.654491, blur: 0, stops: ["#FF66CC", "#FF1493"] },
] as const;

/** Displaced copies of the spine — the bolt itself. Figma layers v15–v18. */
const BOLT_LAYERS = [
  { width: 1.96347, blur: 2.61796, stops: ["#FF80DF", "#FF1493"] },
  { width: 1.30898, blur: 1.30898, stops: ["#FF80DF", "#FF1493"] },
